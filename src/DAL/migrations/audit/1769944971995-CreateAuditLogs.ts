...
export class CreateAuditLogs1769944971995 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "audit_log" ("id" SERIAL NOT NULL, "recordName" character varying NOT NULL, "username" character varying NOT NULL, "authorizedBy" character varying NOT NULL, "action" character varying NOT NULL, "authorizedAt" TIMESTAMP NOT NULL DEFAULT now(), "data" jsonb, CONSTRAINT "PK_07fefa57f7f5ab8fc3f52b3ed0b" PRIMARY KEY ("id"))`
    );
